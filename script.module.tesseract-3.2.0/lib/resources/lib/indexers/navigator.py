...
class navigator:
    ...
    NEWSFILE      = 'https://raw.githubusercontent.com/kodibae/repository.kodibae/master/plugin.video.tesseract/newsinfo.txt'
...
#            self.addDirectoryItem(32032, 'tvshows&url=imdbwatchlist', 'imdb.png', 'DefaultTVShows.png')
    ...
    def addDirectoryItem(self, name, query, thumb, icon, context=None, queue=False, isAction=True, isFolder=True):
        ...
        cm = []
        cm.append(('Tesseract Settings', 'RunPlugin(%s?action=openSettings&query=(0,0))' % sysaddon))
